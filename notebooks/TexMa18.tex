...
\usepackage{amsmath,amsfonts,amssymb,graphicx,listings,color,float,wrapfig,mathtools,longtable,caption}
...
\setlength\parindent{110pt}\indent$\uparrow$\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space\space$\uparrow$}\\
\end{addmargin}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=1\textwidth]{Downloads/naturdiaTry2.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=1\textwidth]{Downloads/compdiaTry2.png}
